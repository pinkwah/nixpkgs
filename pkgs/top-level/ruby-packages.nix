{
  ...
  kramdown-rfc2629 = {
    dependencies = ["certified" "differ" "json_pure" "kramdown" "kramdown-parser-gfm" "net-http-persistent" "unicode-blocks" "unicode-name" "unicode-scripts"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
  ...
  prism = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "24ff9cd3232346e68052659f14c9a618022ea98935f774df465206aba5c06d2f";
      type = "gem";
    };
    version = "1.2.0";
  };
  ...
  rbs = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "ed7273d018556844583d1785ac54194e67eec594d68e317d57fa90ad035532c0";
      type = "gem";
    };
    version = "3.6.1";
  };
  ...
  ruby-lsp = {
    dependencies = ["language_server-protocol" "prism" "sorbet-runtime" "rbs"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "d2ea9dda3016dc48475e7080151aaaada91bb4cc51256f2602e73b207356e2ea";
      type = "gem";
    };
    version = "0.22.1";
  };
